...
public class BaseDict {
	...
	public String getDict_meno() {
		return dict_meno;
	}

	public void setDict_meno(String dict_meno) {
		this.dict_meno = dict_meno;
	}
	...
	public String toString() {
		return "BaseDict [dict_id=" + dict_id + ", dict_type_code=" + dict_type_code + ", dict_type_name="
				...
				+ ", dict_sort=" + dict_sort + ", dict_enabl=" + dict_enable + ", dict_meno=" + dict_meno + "]";
	}
