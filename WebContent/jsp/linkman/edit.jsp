...
<BODY>
	<s:form id="form1" name="form1" method="post" theme="simple" namespace="/"
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>所属客户：</td>
								<td colspan="3">
									<s:select list="list" name="customer.cust_id" cssStyle="WIDTH: 180px" headerKey="" headerValue="-请选择-" listKey="cust_id" listValue="cust_name" />
								</td>
							</tr>
							<TR>
								<td>联系人名称：</td>
							...
							<TR>
								...
								<td>联系人备注 ：</td>
								<td>
								<s:textarea cols="28" rows="3" name="lkm_memo"/>
								</td>
							</TR>
							<tr>
								<td rowspan="2">
