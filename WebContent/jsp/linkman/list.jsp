											...
											<TBODY>
												<TR>
													...
													<TD><input class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="lkm_name"  value="<s:property value="model.lkm_name"/>"></TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD><s:property value="lkm_email"></s:property></TD>
													<TD><s:property value="lkm_qq"></s:property></TD>
													<TD><s:property value="lkm_position"></s:property></TD>
													<TD><s:property value="customer.cust_name"></s:property></TD>
													<TD>
													<a href="${pageContext.request.contextPath}/linkman_edit.action?lkm_id=<s:property value="lkm_id"/>">
														修改
													</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath}/linkman_delete.action?lkm_id=<s:property value="lkm_id"/>">
														删除
													</a>
													</TD>
												</TR>
						...
						<TR>
									<TD><SPAN id=pagelink>
											<DIV style="LINE-HEIGHT: 20px; HEIGHT: 20px; TEXT-ALIGN: right">
												共[<B><s:property value="totalCount"></s:property></B>]条记录,[<B><s:property value="totalPage"></s:property></B>]页
												,每页显示
												<select  id="pageSize1" onchange="to_page()">
													<option value="3"
														<s:if test="pageSize == 3">selected</s:if>>3
													</option>
													<option value="5"
														<s:if test="pageSize == 5">selected</s:if>>5
													</option>
													<option value="10"
														<s:if test="pageSize == 10">selected</s:if>>10
													</option>
												</select>
												条，
