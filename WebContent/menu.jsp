									...
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												...
												<TR> 
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath }/customer_findAll.action?pageSize=&&currPage=" target=main>－ 客户列表</A>
													</TD>
												</TR>
									...
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath }/linkman_saveUI.action" target=main>－新增联系人</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath }/linkman_findAll.action?pageSize=&&currPage=" target=main>－联系人列表</A>
													</TD>
												</TR>
